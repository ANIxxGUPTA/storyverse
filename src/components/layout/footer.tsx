...
import { BookOpen, Send, Code, Globe, MessageSquare, Shield, CheckCircle } from "lucide-react";
        ...
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-xs">
              ...
              <li>
                <Link href="/communities" className="hover:text-zinc-900 dark:hover:text-white transition-colors">
                  Genre Hubs
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-xs">
              ...
              <li>
                <span className="cursor-not-allowed text-zinc-650">Privacy Guidelines</span>
              </li>
            </ul>
          </div>
