  ...
  return (
    <div className="w-full max-w-md rounded-2xl border border-zinc-300 dark:border-zinc-800 bg-zinc-100/60 dark:bg-zinc-900/60 p-8 shadow-xl backdrop-blur-md">
      ...
      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        ...
        {success && (
          <div className="rounded-lg bg-emerald-500/15 border border-emerald-500/20 p-3 text-xs text-emerald-600 dark:text-emerald-400 text-center">
            {success}
          </div>
        )}
...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-transparent px-6 py-12">
      ...
      <Suspense fallback={
        <div className="w-full max-w-md rounded-2xl border border-zinc-300 dark:border-zinc-800 bg-zinc-100/60 dark:bg-zinc-900/60 p-8 shadow-xl backdrop-blur-md text-center text-sm text-zinc-600 dark:text-zinc-400">
          Loading login form...
        </div>
      }>
        <LoginForm />
